...
#ifndef TFTT_PRIVATE_H_
#define TFTT_PRIVATE_H_
...
static const uint8 TFT_CHAR_font_ARRAY[96][6] = {
...
static void TFT_voidWriteData (uint8 copy_uint8Data)      ;
static void TFT_voidWriteCommand (uint8 copy_uint8Command);
static void voidDrawPixel (uint16 copy_uint16X , uint16 copy_uint16Y , uint16 copy_uint16Colour);
static void voidSetAddress (uint16 copy_u16StartX ,uint16 copy_u16EndX , uint16 copy_uint16StartY , uint16 copy_u16EndY);
